...
-- Hibernate Envers Audit Revision Tables
...
CREATE TABLE gsuif_project_aud (
    id               CHAR(36)     NOT NULL,
    ...
    CONSTRAINT pk_gsuif_project_aud PRIMARY KEY (id, rev),
    CONSTRAINT fk_gsuif_project_aud_rev FOREIGN KEY (rev) REFERENCES revinfo (rev)
);

CREATE TABLE gsuif_page_aud (
    id               CHAR(36)     NOT NULL,
    rev              INTEGER      NOT NULL,
    revtype          SMALLINT     NOT NULL,
    ...
    last_modified_by VARCHAR(100) NULL,
    current_metadata_version_id CHAR(36) NULL,
    CONSTRAINT pk_gsuif_page_aud PRIMARY KEY (id, rev),
    CONSTRAINT fk_gsuif_page_aud_rev FOREIGN KEY (rev) REFERENCES revinfo (rev)
);

CREATE TABLE gsuif_metadata_version_aud (
    id               CHAR(36)     NOT NULL,
    rev              INTEGER      NOT NULL,
    revtype          SMALLINT     NOT NULL,
    project_id       CHAR(36)     NULL,
    ...
    created_by       VARCHAR(100) NULL,
    last_modified_by VARCHAR(100) NULL,
    CONSTRAINT pk_gsuif_metadata_version_aud PRIMARY KEY (id, rev),
    CONSTRAINT fk_gsuif_metadata_version_aud_rev FOREIGN KEY (rev) REFERENCES revinfo (rev)
);
