...
- OQ-04: Generated code must not depend on Jmix libraries. Jmix is REJECTED as a generation foundation / output tool; Phase 1 generation stays TemplateOnlyProvider (FreeMarker). *(DEC-021 / T-08 / SCRUM-37)*
